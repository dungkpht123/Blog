...
public class AdminController {
    ...
    public String login(@RequestParam("userName") String userName,
        ...
        if (!StringUtils.hasText(verifyCode)) {
            session.setAttribute("errorMsg", "Mã xác minh phải được điền");
            return "admin/login";
        }
...
// Thời gian hết hạn phiên được đặt thành 7200 giây, hai giờ          
  //session.setMaxInactiveInterval(60 * 60 * 2);
    ...
    public String passwordUpdate(HttpServletRequest request, @RequestParam("originalPassword") String originalPassword,
        ...
        if (!StringUtils.hasText(originalPassword) || !StringUtils.hasText(newPassword)) {
            return "Tham số không thể trống";
        }
        Integer loginUserId = (int) request.getSession().getAttribute("loginUserId");
        if (adminUserService.updatePassword(loginUserId, originalPassword, newPassword)) {
            //Sau khi sửa đổi thành công, hãy xóa dữ liệu trong phiên, điều khiển phía trước nhảy vào trang đăng nhập
